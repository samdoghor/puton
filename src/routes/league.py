...
LeagueBlueprint.route(
    "/leagues", methods=['POST'])(LeagueResource.create)
LeagueBlueprint.route(
    "/leagues", methods=['GET'])(LeagueResource.read_all)
LeagueBlueprint.route(
    "/leagues/<uuid:id>", methods=['GET'])(LeagueResource.read_one)
LeagueBlueprint.route(
    "/leagues/<uuid:id>", methods=['PUT'])(LeagueResource.update)
LeagueBlueprint.route(
    "/leagues/<uuid:id>",
